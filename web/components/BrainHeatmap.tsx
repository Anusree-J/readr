/**
 * Symbolic cortex view. We render a stylised lateral view of the brain
 * (not an anatomically precise fsaverage5 flatmap -- that would require
 * nilearn server-side rendering) with five patches per ROI, tinted by
 * each ROI's normalized peak response.
 */
...
const ROI_PATCHES: {
  ...
  // visual: occipital patch (back of brain)
